...
- Added `toTimestamp` function to the `DateFormatter` class
...
- Removed `string-to-color` dependency
...
- `resultCount` to the pagination type.

## [2.2.0] - 2025-12-10

### Added

- A `dev` and `debug` function to the logger.

## [2.1.3] - 2025-10-09

### Removed

- Removed accidentally re-added dependencies.
